# Руководство пользователя Sanatorium Booking System

Система Sanatorium Booking System предназначена для автоматизации управления санаторием, включая бронирование номеров, учет процедур, планирование задач персонала и аналитику.
