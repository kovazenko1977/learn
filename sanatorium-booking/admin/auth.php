...
$permissionMap = [
    ...
    'procedures_doctor.php' => 'assign_procedures',
    'procedures_cashier.php' => 'manage_payments',
    'procedures_nurse.php' => 'record_attendance',
    'procedures_analytics.php' => 'view_analytics',
];
