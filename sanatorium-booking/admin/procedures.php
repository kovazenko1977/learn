...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    if ($_POST['action'] === 'save') {
        $store->save('procedures', [
            ...
            'break_time' => (int)$_POST['break_time']
        ]);
    ...
    <div class="table-responsive"><table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($i['break_time'] ?? 0); ?> мин.</td>
                <td>
    ...
    <form method="post">
        ...
        <div class="grid-2">
            ...
            <div>
                ...
                <input type="number" name="break_time" id="item-break" required value="0">
            </div>
        </div>
...
<script>
    function editItem(item) {
        ...
        document.getElementById('item-break').value = item.break_time || 0;
    ...
    function resetForm() {
        ...
        document.getElementById('item-break').value = '0';
