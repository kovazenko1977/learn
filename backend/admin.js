...
// GET /api/admin/users (accessible to all authenticated users so display names/executors can be fetched)
...
// GET /api/admin/form-fields (accessible to all authenticated users for ticket creation/viewing)
...
// GET /api/admin/settings (accessible to all authenticated users for categories and SLA info)
