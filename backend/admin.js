...
// GET requests for users, form-fields, and settings are readable by all authenticated users.
// Mutations (POST, PUT, DELETE) require administrative privileges.
...
router.post('/form-fields', adminOnly, async (req, res) => {
...
router.delete('/form-fields/:id', adminOnly, async (req, res) => {
  try {
...
router.post('/settings/storage-mode', adminOnly, async (req, res) => {
