...
// GET /api/admin/users (Accessible to all authenticated users for display names)
...
// GET /api/admin/form-fields (Accessible to all authenticated users for dynamic form creation)
...
// DELETE /api/admin/form-fields/:id (Admin only)
...
// GET /api/admin/settings (Accessible to all authenticated users for categories/priorities)
...
// POST /api/admin/settings/storage-mode - Switch Database (Admin only)
