...
const uploadsPath = fs.existsSync(path.resolve('uploads')) ? path.resolve('uploads') : path.join(__dirname, 'uploads');
app.use('/uploads', express.static(uploadsPath));

// Serve compiled frontend assets
let frontendPublicPath = path.join(__dirname, 'public');
if (!fs.existsSync(frontendPublicPath) && fs.existsSync(path.resolve('public'))) {
  frontendPublicPath = path.resolve('public');
}
