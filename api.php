...
function get_default_settings() {
    return [
        ...
        'quick_buttons' => [
            ['title' => '💰 Цены на путевки', 'action' => 'message', 'payload' => 'Какие цены на путевки?'],
            ['title' => '🏥 Услуги и процедуры', 'action' => 'message', 'payload' => 'Какие услуги и процедуры у вас есть?'],
            ['title' => '📞 Контакты', 'action' => 'message', 'payload' => 'Какие у вас контакты?'],
            ['title' => '📝 Заявка на расчет', 'action' => 'form', 'payload' => 'feedback'],
        ],
        'schedule' => [
        ...
        'auto_responders' => [
            ...
            ['trigger' => 'цены', 'response' => 'Цены на путевки зависят от категории номера и лечебной программы (начинаются от 1500 рублей/сутки). Для точного расчета оставьте заявку через кнопку внизу чата!'],
            ['trigger' => 'услуги', 'response' => 'Мы предлагаем широкий спектр оздоровительных услуг: бальнеотерапия, грязелечение, массаж, ингаляции и диагностика. Напишите слово "запись" для бронирования!'],
            ['trigger' => 'процедуры', 'response' => 'Наши ключевые лечебные процедуры: минеральные ванны, лечебная физкультура, физиотерапия и спа-комплексы.'],
        ],
        'smart_rules' => [
