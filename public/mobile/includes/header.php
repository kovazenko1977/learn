...
<head>
    ...
    <title><?php echo $pageTitle; ?> | wesbooking Mobil../title>
    <link rel="stylesheet" href="../asse../c../admin.css">
...
<body class="mobile-body">
    <div id="pwa-install-banner-m" style="display:none; background: var(--mobile-primary); color: white; padding: 12px; font-size: 0.85rem; justify-content: space-between; align-items: center; border-radius: 0 0 12px 12px;">
        ...
        <button id="pwa-install-btn-m" style="background: white; color: var(--mobile-primary); border: none; padding: 6px 12px; border-radius: 6px; font-weight: 700;">Установит../button>
   ../div>
    <script>
        let deferredPromptM;
   ...
   ../script>
    <header class="mobile-header">
        ...
        <div style="display: flex; align-items: center; gap: 8px;">
            <a href="../index.php" style="color: #64748b; font-size: 0.75rem; text-decoration: none; background: #f1f5f9; padding: 4px 8px; border-radius: 4px;">PC Верси../a>
