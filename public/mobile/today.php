...
<div id="arrivals-tab">
    <h3 style="font-size: 0.9rem; color: #64748b; margin-bottom: 12px;">Гости на заез../h3>
    <?php if (empty($arrivals)): ?>
        <p style="text-align: center; color: #94a3b8; font-size: 0.9rem; margin-top: 40px;">Нет заездов на сегодн../p>
    <?php endif; ?>
    <?php foreach ($arrivals as $b): ?>
        <div class="m-card" style="padding: 12px;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                <div>
                    <div style="font-weight: 700; color: #1e293b;"><?php echo htmlspecialchars($b['client_name'] ?? ../A'); ?../div>
           ...
           ../div>
            <div style="margin-top: 12px; border-top: 1px solid #f1f5f9; pt: 10px;">
                <a href="../index.php" class="btn-m btn-m-primary" style="font-size: 0.75rem; padding: 6px;">Управлени../a>
           ../div>
       ../div>
    <?php endforeach; ?>
</div>
...
<div id="departures-tab" style="display: none;">
    <h3 style="font-size: 0.9rem; color: #64748b; margin-bottom: 12px;">Гости на выез../h3>
    <?php if (empty($departures)): ?>
        <p style="text-align: center; color: #94a3b8; font-size: 0.9rem; margin-top: 40px;">Нет выездов на сегодн../p>
    <?php endif; ?>
            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
               ...
               ../div>
                <div style="text-align: right;">
                    ...
                    <span class="badge-m badge-m-success">Проживае../span>
               ../div>
           ../div>
            <div style="margin-top: 12px; border-top: 1px solid #f1f5f9; pt: 10px;">
                <a href="../index.php" class="btn-m btn-m-primary" style="font-size: 0.75rem; padding: 6px; background: #f97316;">Оформить выез../a>
           ../div>
       ../div>
    <?php endforeach; ?>
</div>
