...
if ($action === 'recover' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($userFound) {
        ...
        // Log the token securely for administration/testing instead of returning it in public HTTP response
        error_log("RECOVERY TOKEN for user_id {$userFound['id']}: $token");
