...
if ($method === 'GET') {
    ...
    $logger->log($userData['id'], "Task Created", "Task ID: {$newTask['id']}, Title: {$newTask['title']}");
    ...
    foreach ($tasks as &$t) {
        if ($t['id'] == $id) {
            ...
            if ($userData['role'] === 'Executor' && $t['assigned_to'] != $userData['id']) {
            ...
            if (isset($input['status'])) {
                $logger->log($userData['id'], "Task Status Change", "Task ID: $id, From: {$t['status']}, To: {$input['status']}");
            ...
            if (isset($input['assigned_to'])) {
                $logger->log($userData['id'], "Task Assignment", "Task ID: $id, Assigned To: {$input['assigned_to']}");
