...
const translations = {
  RU: {
    ...
    notifEvent: 'Событие',
    notifAssignment: 'Назначение задачи',
    notifStatus: 'Изменение статуса',
    notifComment: 'Новый комментарий',
    notifSla: 'Оповещения SLA',
    notifFrequency: 'Частота уведомлений',
    notifInstantly: 'Немедленно',
    notifDaily: 'Раз в день',
    notifWeekly: 'Раз в неделю'
  },
  EN: {
    appName: 'CRM Tickets',
    dashboard: 'Dashboard',
    ...
    notifEvent: 'Event',
    notifAssignment: 'Task Assignment',
    notifStatus: 'Status Change',
    notifComment: 'New Comment',
    notifSla: 'SLA Alerts',
    notifFrequency: 'Notification Frequency',
    notifInstantly: 'Instantly',
    notifDaily: 'Once a Day',
    notifWeekly: 'Once a Week'
  }
};
