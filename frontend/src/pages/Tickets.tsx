...
export const Tickets: React.FC<{ currentUser: any }> = ({ currentUser }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filter Toolbar */}
      <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm flex flex-wrap gap-3 items-center no-print">
        {/* Search Input */}
      ...
      {isHeadOrAdmin && selectedTicketIds.length > 0 && (
        <div className="bg-primary-50 dark:bg-primary-950/20 border border-primary-200/50 dark:border-primary-900/30 p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shadow-sm no-print">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead>
              ...
              {isHeadOrAdmin && <th className="p-4 w-10 no-print"></th>}
              ...
              <th className="p-4 text-right no-print">{t('actions')}</th>
              </tr>
            </thead>
      ...
      {isHeadOrAdmin && viewMode === 'kanban' && (
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm mt-8 no-print">
