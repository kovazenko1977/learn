                    ...
                    <td className="p-4 font-medium text-slate-500">
                      {ticket.deadline ? (
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <span>{formatDateTime(ticket.deadline)}</span>
                          {isOverdue(ticket) && (
                            <span className="px-1.5 py-0.5 rounded bg-red-100 dark:bg-red-950/50 text-red-600 dark:text-red-400 text-[10px] font-bold border border-red-200/50 animate-pulse">
                              Просрочено SLA
                            </span>
                          )}
                        </div>
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex items-center gap-1">
                          {isOverdue(ticket) && (
                            <span className="px-1.5 py-0.5 rounded bg-red-100 dark:bg-red-950/50 text-red-600 dark:text-red-400 text-[9px] font-bold border border-red-200/50 animate-pulse">
                              SLA
                            </span>
                          )}
