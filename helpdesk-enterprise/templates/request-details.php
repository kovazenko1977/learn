                    ...
                    <?php foreach ($comments as $comment): ?>
                        <div style="margin-bottom: 12px; padding-bottom: 8px; border-bottom: 1px solid #f1f5f9;">
                            <div style="display: flex; justify-content: space-between; font-size: 12px; margin-bottom: 4px;">
                                <span style="font-weight: 700;"><?php echo get_userdata($comment->user_id)->display_name; ?></span>
        ...
        <div class="hd-side-col">
            <section class="hd-detail-section" style="background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid var(--hd-border);">
                ...
                <div style="font-size: 14px; display: grid; gap: 8px;">
                    ...
                    <div><strong><?php _e('Ответственный:', 'helpdesk-enterprise'); ?></strong><br><?php echo get_userdata($request->responsible_id)->display_name; ?></div>
                    <div><strong><?php _e('Исполнитель:', 'helpdesk-enterprise'); ?></strong><br><?php echo $request->executor_id ? get_userdata($request->executor_id)->display_name : '<span style="color: var(--hd-danger)">Не назначен</span>'; ?></div>
