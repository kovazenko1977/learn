    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo $base; ?>sync.php" class="<?php echo $currentFile == 'sync.php' ? 'active' : ''; ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 2v6h-6M2.5 22v-6h6M2 12c0-4.4 3.6-8 8-8 1.5 0 2.8.4 4 1.1M22 12c0 4.4-3.6 8-8 8-1.5 0-2.8-.4-4-1.1"></path></svg>
